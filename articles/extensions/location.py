...
class Extension(extensions.Extension):
    def handle_model(self):
        self.model.add_to_class('location',
            models.PointField(verbose_name=_('location'),
    ...
    def handle_modeladmin(self, modeladmin):
        if not issubclass(modeladmin, admin.OSMGeoAdmin):
            warnings.warn(
                "The admin class articles ArticleAdmin class is not a"
                " subclass of django.contrib.gis.admin.OSMGeoAdmin. "
                "Consider setting ARTICLE_MODELADMIN_CLASS = "
